...
define('PROTOCOL', 'http:'.DS.DS);
define('ROOT', PROTOCOL . 'www.sstore.com.br'.DS);
define('IMG', ROOT . 'img'.DS);
define('LOGOS', IMG . 'logo'.DS);
define('PRODUCTS', IMG . 'product'.DS);
define('CATEGORY', IMG . 'category'.DS);
define('PRIVATE_DIR', dirname(__FILE__));
define('LAYOUT_DIR', PRIVATE_DIR.DS.'layout'.DS);
define('CLASS_DIR', PRIVATE_DIR.DS.'class'.DS);
define('CLASS_CEP_DIR', CLASS_DIR.DS.'CEP'.DS);
...
define('DEFAULT_ID', 'id_');
	...
	define('USERS_SHORT_NAME', 'short_name');
